...
{
	g_test_add_func("/credentials/new_ref_unref", test_credentials_new_ref_unref);
	g_test_add_func("/credentials/get", test_credentials_get);
	g_test_add_func("/credentials/serialize", test_credentials_serialize);
}
