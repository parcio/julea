...
def benchmark_db_entry(benchmarkrun_list, iterations, machine_readable, op_duration):
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/insert", iterations, machine_readable, op_duration), benchmark_db_insert)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/insert-batch", iterations, machine_readable, op_duration), benchmark_db_insert_batch)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/insert-index-single", iterations, machine_readable, op_duration), benchmark_db_insert_index_single)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/insert-batch-index-single", iterations, machine_readable, op_duration), benchmark_db_insert_batch_index_single)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/insert-index-all", iterations, machine_readable, op_duration), benchmark_db_insert_index_all)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/insert-batch-index-all", iterations, machine_readable, op_duration), benchmark_db_insert_batch_index_all)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/insert-index-mixed", iterations, machine_readable, op_duration), benchmark_db_insert_index_mixed)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/insert-batch-index-mixed", iterations, machine_readable, op_duration), benchmark_db_insert_batch_index_mixed)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/delete", iterations, machine_readable, op_duration), benchmark_db_delete)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/delete-batch", iterations, machine_readable, op_duration), benchmark_db_delete_batch)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/delete-index-single", iterations, machine_readable, op_duration), benchmark_db_delete_index_single)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/delete-batch-index-single", iterations, machine_readable, op_duration), benchmark_db_delete_batch_index_single)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/delete-index-all", iterations, machine_readable, op_duration), benchmark_db_delete_index_all)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/delete-batch-index-all", iterations, machine_readable, op_duration), benchmark_db_delete_batch_index_all)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/delete-index-mixed", iterations, machine_readable, op_duration), benchmark_db_delete_index_mixed)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/delete-batch-index-mixed", iterations, machine_readable, op_duration), benchmark_db_delete_batch_index_mixed)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/update", iterations, machine_readable, op_duration), benchmark_db_update)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/update-batch", iterations, machine_readable, op_duration), benchmark_db_update_batch)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/update-index-single", iterations, machine_readable, op_duration), benchmark_db_update_index_single)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/update-batch-index-single", iterations, machine_readable, op_duration), benchmark_db_update_batch_index_single)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/update-index-all", iterations, machine_readable, op_duration), benchmark_db_update_index_all)
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/update-batch-index-all", iterations, machine_readable, op_duration), benchmark_db_update_batch_index_all)
    ...
    append_to_benchmark_list_and_run(benchmarkrun_list, BenchmarkRun("/db/entry/update-batch-index-mixed", iterations, machine_readable, op_duration), benchmark_db_update_batch_index_mixed)
