...
gboolean j_endpoint_init_(JEndpoint**, JFabric*, JDomainManager*, JConfiguration*, struct fi_info*, struct fi_info*, const gchar*);
void j_endpoint_fini_(JEndpoint*, JDomainManager*, const gchar*);
...
gboolean j_endpoint_shutdown_test_(JEndpoint*, const gchar*, const gchar*);
...
struct fid_domain* jendpoint_get_domain(JEndpoint*, JConnectionType);
